...
# TRACKER FACTORY
# ==============================
def build_tracker() -> ByteTrack:
    """Instantiate ByteTrack aligned with the effective repo/YAML behavior."""
    return ByteTrack(
        min_conf=0.1,
        track_thresh=0.6,
        match_thresh=0.9,
...
# ==============================
def main():
    p = argparse.ArgumentParser(description="ByteTrack wrapper for MOT tracking from JSON detections")
