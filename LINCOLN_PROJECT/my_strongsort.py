...
# TRACKER FACTORY
# ==============================
def build_tracker(cfg: Config) -> StrongSort:
    ...
    # Match the effective CLI/default repo behavior for StrongSort
    return StrongSort(
...
# ==============================
def main():
    p = argparse.ArgumentParser(description="StrongSort wrapper for MOT tracking from JSON detections")
