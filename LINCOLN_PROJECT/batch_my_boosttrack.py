"""
Batch wrapper for my_boosttrack.py: traverses a root hierarchy with
Annotation/ and Data/ and generates results in Results/BoostTrack/ for all
...
from my_boosttrack import Config, run as run_tracker
...
def process_scene(root: Path, scene_ann_dir: Path, args) -> None:
    ...
    out_scene_dir = root / "Results/BoostTrack" / scene_label_name
...
def main():
    p = argparse.ArgumentParser(
        description="Processes all scenarios/cameras from a root directory containing Annotation/ and Data/ folders, and generates tracking results in Results/BoostTrack/"
    )
